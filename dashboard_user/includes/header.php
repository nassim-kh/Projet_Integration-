...
<body>
<header style="background:rgb(142, 51, 180);">
  ...
  overflow: hidden;"></a></h1>
    <nav>
        ...
        <a href="./edit.php">change_Profile</a>
        <a href="../php/logout.php">logout</a><br><br>
    ...
    <div>
        <a href="index.php?category=Entrée" style="color:white;">Entrées</a> | 
        <a href="index.php?category=Plat"style="color:white;">Plats</a> | 
        <a href="index.php?category=Dessert"style="color:white;">Desserts</a>
    </div>
</header>
<main>
